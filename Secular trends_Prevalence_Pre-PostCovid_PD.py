...
df=pd.read_csv('C:/Users/llee/Downloads/V1_20250313_Secular_trends_PREV_all_years_with_rate.csv')
df
...
print(df.groupby('gender')['uksp_rate'].sum().reset_index(), " ",
...
pdf=df[['year','age','gender','ln_denom','denom','uksp_rate']]
...
#Export to csv
X_test.to_csv('G:\My Drive\\20250328_PD_Prev_Pre-PostCovid.csv')
